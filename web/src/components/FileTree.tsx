...
function PythonFileIcon() {
  return (
    <svg width="16" height="16" viewBox="0 0 16 16" fill="none">
      ...
      <text x="4" y="10" fontSize="5" fill="#f0e060" fontWeight="bold" fontFamily="monospace">
        py
      </text>
    </svg>
  );
  ...
  return (
    <div>
      <div
        ...
        onDragStart={
          !entry.is_dir && entry.name.endsWith(".ffpy")
            ? (e) => {
...
const DIALOG_LABELS: Record<DialogKind, { title: string; placeholder: string; ext?: string }> = {
  ...
  ffsq: {
    title: "New Sequence File",
    placeholder: "filename.ffsq",
    ext: ".ffsq",
  },
      ...
      <div className="filetree-header">
        ...
        <div className="filetree-header-actions">
          <button
            ...
            title="New Scene File (.ffpy)"
            onClick={() => setDialog("ffpy")}
          >
            <svg width="16" height="16" viewBox="0 0 16 16" fill="none">
          ...
          <button
            className="filetree-action-btn"
            title="New Sequence File (.ffsq)"
            onClick={() => setDialog("ffsq")}
          >
            <svg width="16" height="16" viewBox="0 0 16 16" fill="none">
      ...
      {dialog !== null && (
        <div className="filetree-dialog">
          ...
          <div className="filetree-dialog-buttons">
            <button className="filetree-dialog-btn filetree-dialog-btn-ok" onClick={handleCreate}>
              Create
            </button>
            <button
              className="filetree-dialog-btn filetree-dialog-btn-cancel"
